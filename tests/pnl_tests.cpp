...
TEST(PnLStructTest, NetPositionLongOnly) {
    PnL pnl{.long_position = Quantity{100}, .short_position = Quantity{0}, .cash = Cash{0}};
    EXPECT_EQ(pnl.net_position(), 100);
}

TEST(PnLStructTest, NetPositionShortOnly) {
    PnL pnl{.long_position = Quantity{0}, .short_position = Quantity{100}, .cash = Cash{0}};
    EXPECT_EQ(pnl.net_position(), -100);
}

TEST(PnLStructTest, NetPositionMixedLongDominant) {
    PnL pnl{.long_position = Quantity{150}, .short_position = Quantity{50}, .cash = Cash{0}};
    EXPECT_EQ(pnl.net_position(), 100);
}

TEST(PnLStructTest, NetPositionMixedShortDominant) {
    PnL pnl{.long_position = Quantity{50}, .short_position = Quantity{150}, .cash = Cash{0}};
    EXPECT_EQ(pnl.net_position(), -100);
}

TEST(PnLStructTest, NetPositionFlat) {
    PnL pnl{.long_position = Quantity{100}, .short_position = Quantity{100}, .cash = Cash{0}};
...
TEST(PnLStructTest, UnrealizedPnLFlatPosition) {
    PnL pnl{.long_position = Quantity{50}, .short_position = Quantity{50}, .cash = Cash{0}};
...
TEST(PnLStructTest, TotalPnLBreakeven) {
    ...
    PnL pnl{.long_position = Quantity{100}, .short_position = Quantity{0}, .cash = Cash{-100000}};
...
TEST(PnLStructTest, TotalPnLShortProfit) {
    ...
    PnL pnl{.long_position = Quantity{0}, .short_position = Quantity{100}, .cash = Cash{100000}};
...
TEST(PnLStructTest, LargePositionNetPosition) {
    PnL pnl{
        .long_position = Quantity{1000000000},   // 1 billion
...
TEST(PnLStructTest, LargePositionUnrealizedPnL) {
    PnL pnl{
        .long_position = Quantity{1000000},  // 1 million
